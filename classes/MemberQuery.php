...
//$barcode_nmbr = $_barcodeNmbr;
  ...
  function insert($mbr) {
    $sql = $this->mkSQL("insert into member "
                   . "       (mbrid, barcode_nmbr, create_dt, last_change_dt, last_change_userid, last_name, first_name, address, home_phone, work_phone, cel, email, foto,   pass_user,    born_dt, other, classification, is_active) "
                   . "values (null,       %Q,      sysdate(),    sysdate(),            %N,           %Q,         %Q,       %Q,       %Q,         %Q,       %Q,  %Q,    %Q,  md5(lower(%Q)),   %Q,      %Q,       %N,           %Q    ) ",
                        $mbr->getBarcodeNmbr(), 
...
jalg
  ...
  ." last_change_dt = sysdate(), last_change_userid=%N, barcode_nmbr=%Q, last_name=%Q, first_name=%Q, address=%Q, home_phone=%Q, work_phone=%Q, cel=%Q, email=%Q, foto=%Q, pass_user=%Q, born_dt=%Q, other=%Q, classification=%N, is_active=%Q  where mbrid=%N",
                        $mbr->getLastChangeUserid(),
                        $mbr->getBarcodeNmbr(), 
                        $mbr->getLastName(), 
                        $mbr->getFirstName(),
